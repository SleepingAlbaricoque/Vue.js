<template>
  ...
  <form v-on:submit.prevent="submitHandler1">
    <!-- prevent를 붙여서 폼의 submit을 막음; preventDefault()와 같은 기능-->
    <table border="1">
      <tr>
        <td>아이디</td>
  ...
  <button @click="oneClick" :disabled="isActive">한 번만 클릭되는 버튼</button>
...
export default {
  ...
  methods: {
    ...
    handler2: function (value) {
      alert("button2 clicked: " + value);
    },
    handler3: function (e) {
      alert("button3 clicked: " + e);
    },
